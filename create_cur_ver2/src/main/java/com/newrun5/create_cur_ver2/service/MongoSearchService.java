...
public class MongoSearchService
{
    ...
    @Autowired
    public MongoSearchService(MongoTemplate mongoTemplate, EmbeddingModel embeddingModel) {
...
//
//    @Autowired
//    private EmbeddingModel embeddingModel; // EmbeddingModel 주입
//
//    // 벡터 유사도 검색 메서드
//    public List<Document> searchFinancialData(String query) {
//        // 입력 쿼리를 벡터로 변환
//        float[] queryVector = embeddingModel.embed(query);
//
//        // MongoDB에서 벡터 유사도 검색 수행 (예시 코드)
//        // 실제로는 MongoDB Atlas Search 등의 기능을 사용해야 합니다.
//
//        // 예시로 모든 데이터를 반환합니다.
//        Query searchQuery = new Query();
//        searchQuery.limit(5);
//        return mongoTemplate.find(searchQuery, Document.class, "financialData");
//    }
//}
